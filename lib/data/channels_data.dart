...
class ChannelsData {
  ...
  static final List<ChannelModel> allChannels = categories.fold<List<ChannelModel>>(
    [],
    (acc, category) => acc..addAll(
      category.channels.map((ch) => ch.copyWith(category: category.name)),
    ),
  );
}
